<section class="space-y-6">
    ...
    <button class="hover:bg-[#750f0f] transition-colors transition-duration:150ms md:text-base py-2 bg-[#AB1919] rounded-lg h-[40px] w-[150px] md:w-[140px] inline-block text-[#D9C8A9]"
        x-data=""
